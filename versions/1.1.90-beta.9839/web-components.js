          ...
          <div slot="label" part="label" class="calendar__label">
            ${this.navigation ? b2`
                  <hmwc-attachment
                    ...
                    <hmwc-button slot="anchor" basic sm part="month" class="calendar__label-month clickable" label=${this.MONTHS[this.month]}>
                    </hmwc-button>
                  ...
                  <hmwc-attachment
                    ...
                    <hmwc-button slot="anchor" basic sm part="year" class="calendar__label-year clickable" label=${this.year}> </hmwc-button>
