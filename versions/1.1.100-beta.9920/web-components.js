...
`;var M=function(n,t,e,r){var i=arguments.length,o=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,e,r);else for(var l=n.length-1;l>=0;l--)(a=n[l])&&(o=(i<3?a(o):i>3?a(t,e,o):a(t,e))||o);return i>3&&o&&Object.defineProperty(t,e,o),o},w=class extends p{constructor(){super(...arguments),this.target="_blank"}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}isLink(){return!!this.href}handleClick(){if(this.disabled){if(this.submit){let t=this.closest("[form]");t&&t.controllers.form?.validate()}return}this.emit("hmwc-click")}handleFocus(){this.emit("hmwc-focus")}handleBlur(){this.emit("hmwc-blur")}handleMouseIn(){this.labelOnHover&&(this.label=this.labelOnHover)}handleMouseOut(){this.labelOnHover&&(this.label=this._label)}connectedCallback(){super.connectedCallback(),this._label=this.label||this.textContent||"",!this.sm&&!this.md&&!this.lg&&(this.md=!0)}render(){let t=this.isLink()?ze`a`:ze`button`,e=g({button:!0,icon:!!this.icon,prefix:!!this.prefix||!!this.img,suffix:!!this.suffix,invert:!!this.invert,basic:!!this.basic,primary:!!this.primary,success:!!this.success,neutral:!!this.neutral,warning:!!this.warning,danger:!!this.danger,small:!!this.sm,medium:!!this.md,large:!!this.lg,loading:!!this.loading,circle:!!this.circle,pill:!!this.pill,outline:!!this.outline,disabled:!!this.disabled,fluid:!!this.fluid}),r=X`
  ...
  .accordion-group ::slotted(:first-child) {
    border-top-left-radius: calc(var(--accordion-group-border-radius) - var(--hmwc-panel-border-width, 1px));
    border-top-right-radius: calc(var(--accordion-group-border-radius) - var(--hmwc-panel-border-width, 1px));
  }

  .accordion-group ::slotted(:last-child) {
    border-bottom-left-radius: calc(var(--accordion-group-border-radius) - var(--hmwc-panel-border-width, 1px));
    border-bottom-right-radius: calc(var(--accordion-group-border-radius) - var(--hmwc-panel-border-width, 1px));
  }
...
`;var re=function(n,t,e,r){var i=arguments.length,o=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,e,r);else for(var l=n.length-1;l>=0;l--)(a=n[l])&&(o=(i<3?a(o):i>3?a(t,e,o):a(t,e))||o);return i>3&&o&&Object.defineProperty(t,e,o),o},dt=class extends p{constructor(){super(...arguments),this.userUpdate=()=>this.updateProxyUser(),this.logoUpdate=()=>this._logo=this.getLogoVariant()}return(){this.emit("hmwc-navigate",{detail:{route:"/"}})}handleSettingsClick(){window.location.hash="#settings"}handleMenuSelection(t){t.detail.value==="account"?(t.stopImmediatePropagation(),window.location.hash="#settings"):t.detail.value==="logout"&&this.emit("hmwc-navigate",{detail:{route:"/logout"}})}updateProxyUser(){this.proxyUser=this.user?.proxyHost?.firstName?this.user:{}}observeTheme(){new MutationObserver(t=>{t.forEach(e=>{e.type!=="attributes"&&e.attributeName!=="class"||(this._logo=this.getLogoVariant())})}).observe(document.documentElement,{attributes:!0})}getLogoVariant(){let t=document.documentElement.className.includes("theme-dark")?"dark":"light";return this.logo instanceof String?this.logo:!(this.logo instanceof Object)||!this.logo[t]?"":this.logo[t]}navigateFAQ(){this.emit("hmwc-navigate",{detail:{route:"/help-support/faq"}})}setDefaultHMWCLogo(){this.logo||(this.logo={light:"/src/assets/images/hmwc-dark.png",dark:"/src/assets/images/hmwc-light.png"})}connectedCallback(){super.connectedCallback(),this.setDefaultHMWCLogo(),this.observeTheme()}render(){let t=[{value:"account",label:"My Account"},{value:"logout",label:"Logout"}],e=this.user?(this.user.proxyHost?.firstName||this.user.firstName)+" "+(this.user.proxyHost?.lastName||this.user.lastName):"";return c`
    ...
    `}};dt.styles=ji;dt.dependencies=[O,it,V,w,_,E,I];re([b()],dt.prototype,"_logo",void 0);re([b()],dt.prototype,"proxyUser",void 0);re([s({type:String,reflect:!0})],dt.prototype,"title",void 0);re([s()],dt.prototype,"logo",void 0);re([s({type:Object})],dt.prototype,"user",void 0);re([s({type:Boolean,reflect:!0})],dt.prototype,"beta",void 0);re([D("#search")],dt.prototype,"popup",void 0);re([D("hmwc-menu")],dt.prototype,"menu",void 0);re([u("user")],dt.prototype,"userUpdate",void 0);re([u("logo")],dt.prototype,"logoUpdate",void 0);dt.define("hmwc-header",dt);var Pi=d`
  :host {
    --image-width: 100%;
    --image-height: 100%;
...
`;var Zt=function(n,t,e,r){var i=arguments.length,o=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,e,r);else for(var l=n.length-1;l>=0;l--)(a=n[l])&&(o=(i<3?a(o):i>3?a(t,e,o):a(t,e))||o);return i>3&&o&&Object.defineProperty(t,e,o),o},tt=class extends p{constructor(){super(...arguments),this.alignment="start"}valueUpdated(){this.emit("hmwc-change",{detail:{value:this.label}})}firstUpdated(){this.label||(this.label=this.shadowRoot?.querySelector("table-cell__body")?.textContent||"")}render(){let t=g({"table-cell":!0,"align-start":this.alignment==="start","align-center":this.alignment==="center","align-end":this.alignment==="end",icon:!!this.icon,progress:!!this.progress,primary:!!this.primary,success:!!this.success,neutral:!!this.neutral,warning:!!this.warning,danger:!!this.danger});return c`
    ...
    `}};tt.styles=Zi;tt.dependencies=[x,I,W,ut];Zt([s({type:String,reflect:!0})],tt.prototype,"label",void 0);Zt([s({type:String,reflect:!0})],tt.prototype,"icon",void 0);Zt([s({type:Number,reflect:!0})],tt.prototype,"progress",void 0);Zt([s({type:String,reflect:!0})],tt.prototype,"alignment",void 0);Zt([s({type:Number,reflect:!0})],tt.prototype,"index",void 0);Zt([s({type:Boolean,reflect:!0})],tt.prototype,"primary",void 0);Zt([s({type:Boolean,reflect:!0})],tt.prototype,"success",void 0);Zt([s({type:Boolean,reflect:!0})],tt.prototype,"neutral",void 0);Zt([s({type:Boolean,reflect:!0})],tt.prototype,"warning",void 0);Zt([s({type:Boolean,reflect:!0})],tt.prototype,"danger",void 0);Zt([u(["value"])],tt.prototype,"valueUpdated",null);tt.define("hmwc-table-cell",tt);var Qi=d` 
  :host { 
    display: block;
   } 
